...
public static class AppDatabase
{
    ...
    public static void Load(string filedatabase, IProgress<string>? progress, out SortedList<string, Img> imgList, out SortedList<string, string> nameList, out int maxImages)
    {       
        lock (_lock) {
